...
.method public static final J(Ljava/util/List;I)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static final N(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-static {p0}, Lk0/f;->O(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-static {p0, v0}, Lk0/f;->M(Ljava/lang/Iterable;Ljava/util/Collection;)Ljava/util/Collection;

    move-object p0, v0

    .line 2
    :goto_2
    invoke-static {p0}, Lb/a;->y(Ljava/util/List;)Ljava/util/List;
...
.method public static final O(Ljava/util/Collection;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static final P(Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-static {p0, v1}, Lk0/f;->M(Ljava/lang/Iterable;Ljava/util/Collection;)Ljava/util/Collection;
