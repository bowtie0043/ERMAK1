...
.method public final b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Lh/e0;->c(Landroid/content/Context;I)I

    move-result v2

    const v3, 0x7f030050

    invoke-static {p1, v3}, Lh/e0;->b(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Lh/e0;->b:[I
    ...
    invoke-static {v2, p2}, Ln/a;->a(II)I

    move-result p1

    aput p1, v0, v3

    sget-object p1, Lh/e0;->c:[I
...
.method public final c(Lh/a0;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 4
    ...
    invoke-virtual {p1, p2, v0}, Lh/a0;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    const v1, 0x7f070047

    invoke-virtual {p1, p2, v1}, Lh/a0;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 4
    invoke-static {p1, v2}, Lh/e0;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v1, Lh/e0;->e:[I

    aput-object v1, v0, v6

    invoke-static {p1, v5}, Lh/e0;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v2}, Lh/e0;->b(Landroid/content/Context;I)I
    ...
    invoke-virtual {p0, p1, p2}, Lh/e$a;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 6
    invoke-virtual {p0, p1, v1}, Lh/e$a;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, v0, p2}, Lh/e$a;->a([II)Z
    ...
    invoke-static {p1, p2}, Lh/e0;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public final e(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1}, Lh/s;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 1
    sget-object p3, Lh/e;->b:Landroid/graphics/PorterDuff$Mode;
    ...
    :try_start_0
    invoke-static {p2, p3}, Lh/a0;->g(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
