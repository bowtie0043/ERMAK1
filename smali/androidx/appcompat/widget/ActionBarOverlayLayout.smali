...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, Lt/m;->b:Lt/m;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:Lt/m;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lt/m;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lt/m;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:Lt/m;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Lt/h;
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Lh/r;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Lt/h;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Lh/r;->getTitle()Ljava/lang/CharSequence;
...
.method public k()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/Toolbar;->getWrapper()Lh/r;

    move-result-object v0

    .line 2
    :goto_0
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Lh/r;
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-virtual {p1}, Lt/m;->b()I

    move-result v0

    invoke-virtual {p1}, Lt/m;->d()I

    move-result v1

    invoke-virtual {p1}, Lt/m;->c()I

    move-result v3

    invoke-virtual {p1}, Lt/m;->a()I
    ...
    .line 1
    invoke-static {p0, p1, v1}, Lt/k$b;->a(Landroid/view/View;Lt/m;Landroid/graphics/Rect;)Lt/m;
    ...
    .line 3
    iget-object v5, p1, Lt/m;->a:Lt/m$j;

    invoke-virtual {v5, v2, v3, v4, v1}, Lt/m$j;->h(IIII)Lt/m;

    move-result-object v1

    .line 4
    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:Lt/m;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lt/m;

    invoke-virtual {v2, v1}, Lt/m;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:Lt/m;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lt/m;
    ...
    invoke-virtual {p1}, Lt/m$j;->a()Lt/m;
    ...
    invoke-virtual {p1}, Lt/m$j;->c()Lt/m;
    ...
    invoke-virtual {p1}, Lt/m$j;->b()Lt/m;
...
.method public onMeasure(II)V
    ...
    sget-object v4, Lt/k;->a:Ljava/util/WeakHashMap;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:Lt/m;

    iput-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lt/m;
    ...
    .line 3
    iget-object v4, v6, Lt/m;->a:Lt/m$j;

    invoke-virtual {v4, v2, v5, v2, v2}, Lt/m$j;->h(IIII)Lt/m;
    ...
    .line 4
    :cond_4
    invoke-virtual {v6}, Lt/m;->b()I

    move-result v4

    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lt/m;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lt/m;

    invoke-virtual {v5}, Lt/m;->c()I

    move-result v5

    iget-object v7, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lt/m;

    invoke-virtual {v7}, Lt/m;->a()I

    move-result v7

    add-int/2addr v7, v2

    invoke-static {v4, v6, v5, v7}, Ln/b;->a(IIII)Ln/b;

    move-result-object v2

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lt/m;
    ...
    new-instance v5, Lt/m$c;

    invoke-direct {v5, v4}, Lt/m$c;-><init>(Lt/m;)V
    ...
    new-instance v5, Lt/m$b;

    invoke-direct {v5, v4}, Lt/m$b;-><init>(Lt/m;)V
    ...
    invoke-direct {v5, v4}, Lt/m$a;-><init>(Lt/m;)V

    .line 6
    :goto_2
    invoke-virtual {v5, v2}, Lt/m$d;->d(Ln/b;)V

    .line 7
    invoke-virtual {v5}, Lt/m$d;->b()Lt/m;

    move-result-object v2

    .line 8
    :goto_3
    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lt/m;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:Lt/m;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lt/m;

    invoke-virtual {v2, v4}, Lt/m;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_7

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lt/m;

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:Lt/m;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->d:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v4, v2}, Lt/k;->a(Landroid/view/View;Lt/m;)Lt/m;
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Lt/h;
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    .line 3
    iget-boolean p1, v4, Lc/g;->c:Z

    if-nez p1, :cond_4

    iput-boolean v3, v4, Lc/g;->c:Z

    invoke-virtual {v4, v3}, Lc/g;->a(Z)V
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Lh/r;->setIcon(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Lh/r;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Lh/r;->b(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Lh/r;->d(Landroid/view/Window$Callback;)V
...
.method public setWindowTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Lh/r;->c(Ljava/lang/CharSequence;)V
