...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v5, Lb/a;->w:[I

    const/4 v10, 0x0

    invoke-static {v2, p2, v5, v0, v10}, Lh/i0;->n(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lh/i0;

    move-result-object v0

    .line 2
    iget-object v7, v0, Lh/i0;->b:Landroid/content/res/TypedArray;
    ...
    .line 3
    invoke-static/range {v3 .. v9}, Lt/k;->d(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    const/16 p1, 0x1c

    invoke-virtual {v0, p1, v10}, Lh/i0;->i(II)I
    ...
    invoke-virtual {v0, p1, v10}, Lh/i0;->c(II)I

    move-result p1

    const/16 p2, 0x1b

    invoke-virtual {v0, p2}, Lh/i0;->l(I)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {v0, p2, p1}, Lh/i0;->c(II)I
    ...
    invoke-virtual {v0, p1, p2}, Lh/i0;->c(II)I
    ...
    invoke-virtual {v0, p1, p2}, Lh/i0;->d(II)I
    ...
    invoke-virtual {v0, v1, p2}, Lh/i0;->c(II)I

    move-result v1

    const/4 v2, 0x7

    invoke-virtual {v0, v2, v10}, Lh/i0;->d(II)I

    move-result v2

    const/16 v3, 0x8

    invoke-virtual {v0, v3, v10}, Lh/i0;->d(II)I

    move-result v3

    invoke-virtual {p0}, Landroidx/appcompat/widget/Toolbar;->d()V

    iget-object v4, p0, Landroidx/appcompat/widget/Toolbar;->u:Lh/c0;

    .line 8
    iput-boolean v10, v4, Lh/c0;->h:Z

    if-eq v2, p2, :cond_5

    iput v2, v4, Lh/c0;->e:I

    iput v2, v4, Lh/c0;->a:I

    :cond_5
    if-eq v3, p2, :cond_6

    iput v3, v4, Lh/c0;->f:I

    iput v3, v4, Lh/c0;->b:I
    ...
    .line 9
    :cond_7
    invoke-virtual {v4, p1, v1}, Lh/c0;->a(II)V
    ...
    invoke-virtual {v0, p1}, Lh/i0;->e(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1}, Lh/i0;->k(I)Ljava/lang/CharSequence;
...
.method public c()V
    ...
    invoke-direct {v0, v1, v2, v3}, Lh/g;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public final d()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->u:Lh/c0;

    if-nez v0, :cond_0

    new-instance v0, Lh/c0;

    invoke-direct {v0}, Lh/c0;-><init>()V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->u:Lh/c0;
...
.method public getContentInsetEnd()I
    ...
    .line 1
    iget-boolean v1, v0, Lh/c0;->g:Z

    if-eqz v1, :cond_0

    iget v0, v0, Lh/c0;->a:I

    goto :goto_0

    :cond_0
    iget v0, v0, Lh/c0;->b:I
...
.method public onMeasure(II)V
    ...
    invoke-static/range {p0 .. p0}, Lh/l0;->a(Landroid/view/View;)Z
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1
    iget-object v0, p1, Ly/a;->c:Landroid/os/Parcelable;
...
.method public onRtlPropertiesChanged(I)V
    ...
    :cond_1
    iput-boolean v1, v0, Lh/c0;->g:Z

    iget-boolean p1, v0, Lh/c0;->h:Z
    ...
    :cond_2
    iget v1, v0, Lh/c0;->e:I

    :goto_1
    iput v1, v0, Lh/c0;->a:I

    iget v1, v0, Lh/c0;->c:I
    ...
    :cond_5
    iget p1, v0, Lh/c0;->e:I

    iput p1, v0, Lh/c0;->a:I

    :cond_6
    iget v1, v0, Lh/c0;->f:I

    :goto_3
    iput v1, v0, Lh/c0;->b:I
...
.method public setLogo(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 2
    invoke-direct {v0, v1, v3, v2}, Lh/i;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public setSubtitle(Ljava/lang/CharSequence;)V
    ...
    .line 1
    invoke-direct {v1, v0, v2}, Lh/o;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
