...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->m:Lh/y;
    ...
    .line 1
    sget-object p3, Lt/k;->a:Ljava/util/WeakHashMap;
...
.method public a(Landroidx/appcompat/view/menu/d;Z)V
    ...
    iget-object v2, v0, Landroidx/appcompat/view/menu/b$d;->a:Lh/z;

    .line 3
    iget-object v2, v2, Lh/x;->z:Landroid/widget/PopupWindow;
    ...
    .line 6
    :cond_4
    iget-object v0, v0, Landroidx/appcompat/view/menu/b$d;->a:Lh/z;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/b;->i()V
...
.method public g(Landroidx/appcompat/view/menu/j;)Z
    ...
    .line 1
    iget-object p1, v1, Landroidx/appcompat/view/menu/b$d;->a:Lh/z;
...
.method public i()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/b$d;->a:Lh/z;

    invoke-virtual {v3}, Lh/x;->b()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/b$d;->a:Lh/z;

    invoke-virtual {v2}, Lh/x;->i()V
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/b$d;->a:Lh/z;

    invoke-virtual {v4}, Lh/x;->b()Z
...
.method public final w(Landroidx/appcompat/view/menu/d;)V
    ...
    invoke-static {v3, v7, v4, v6}, Lg/d;->n(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I

    move-result v4

    .line 5
    new-instance v6, Lh/z;
    ...
    invoke-direct {v6, v8, v7, v9, v10}, Lh/z;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v8, v0, Landroidx/appcompat/view/menu/b;->m:Lh/y;

    .line 6
    iput-object v8, v6, Lh/z;->C:Lh/y;

    .line 7
    iput-object v0, v6, Lh/x;->q:Landroid/widget/AdapterView$OnItemClickListener;

    .line 8
    iget-object v8, v6, Lh/x;->z:Landroid/widget/PopupWindow;
    ...
    .line 10
    iput-object v8, v6, Lh/x;->p:Landroid/view/View;
    ...
    .line 13
    invoke-virtual {v6, v5}, Lh/x;->j(Z)V
    ...
    .line 15
    invoke-virtual {v6, v3}, Lh/x;->g(Landroid/widget/ListAdapter;)V

    invoke-virtual {v6, v4}, Lh/x;->h(I)V
    ...
    .line 20
    :cond_4
    iget-object v10, v3, Landroidx/appcompat/view/menu/b$d;->a:Lh/z;

    .line 21
    iget-object v10, v10, Lh/x;->d:Lh/t;
    ...
    sget-object v9, Lh/z;->D:Ljava/lang/reflect/Method;

    if-eqz v9, :cond_d

    :try_start_0
    iget-object v10, v6, Lh/x;->z:Landroid/widget/PopupWindow;
    ...
    :cond_c
    iget-object v9, v6, Lh/x;->z:Landroid/widget/PopupWindow;
    ...
    .line 26
    iget-object v9, v9, Landroidx/appcompat/view/menu/b$d;->a:Lh/z;

    .line 27
    iget-object v9, v9, Lh/x;->d:Lh/t;
    ...
    .line 30
    iput-object v7, v6, Lh/x;->p:Landroid/view/View;
    ...
    .line 33
    iput-boolean v5, v6, Lh/x;->l:Z

    iput-boolean v5, v6, Lh/x;->k:Z

    .line 34
    invoke-virtual {v6, v8}, Lh/x;->k(I)V
    ...
    invoke-virtual {v6, v4}, Lh/x;->k(I)V
    ...
    :goto_f
    iput-object v10, v6, Lh/x;->x:Landroid/graphics/Rect;
    ...
    invoke-direct {v4, v6, v1, v5}, Landroidx/appcompat/view/menu/b$d;-><init>(Lh/z;Landroidx/appcompat/view/menu/d;I)V

    iget-object v5, v0, Landroidx/appcompat/view/menu/b;->j:Ljava/util/List;

    invoke-interface {v5, v4}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v6}, Lh/x;->e()V

    .line 40
    iget-object v4, v6, Lh/x;->d:Lh/t;
